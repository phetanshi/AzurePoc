...
namespace WebformsSamlAuth.Auth
{
    public partial class Response
    {
        ...
        public bool IsValid()
        {
            ...
            bool isValidSigRef = ValidateSignatureReference(signedXml);
            bool isValidCert = signedXml.CheckSignature(_certificate, true);
            bool isExpired = IsExpired();

            return isValidSigRef && isValidCert && !isExpired;
        }
